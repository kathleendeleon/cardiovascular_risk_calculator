...
- **bp_tx** — On blood pressure treatment (`1 = yes`, `0 = no`)  
- **sbp_sd** — Standard deviation of systolic BP (for QRISK3; optional)  

**Lipids**
- **total_c** — Total cholesterol (mg/dL or mmol/L, depending on selected units)  
- **hdl_c** — HDL cholesterol (mg/dL or mmol/L)  
- **statin** — Currently on statin therapy (`1 = yes`, `0 = no`)  

**Metabolic / Diabetes**
- **diabetes** — Diabetes diagnosis (`1 = yes`, `0 = no`)  
- **hba1c** — Hemoglobin A1c (%) (optional, used in extended PREVENT models)  
- **bmi** — Body Mass Index (kg/m²)  

**Kidney Function**
- **egfr** — Estimated glomerular filtration rate (mL/min/1.73m²)  
- **uacr** — Urine albumin-to-creatinine ratio (mg/g) (optional for PREVENT)  

**Lifestyle**
- **smoker** — Current smoker (`1 = yes`, `0 = no`)  
- **qrisk_smoke_cat** — Smoking category for QRISK3 (0–4 scale; optional)  

**Socioeconomic / QRISK-Specific**
- **townsend** — Townsend deprivation score (QRISK3; optional)  
- **qrisk_ethnicity** — QRISK3 ethnicity category (integer code; optional)  

**QRISK3 Comorbidities (Optional)**
- **fh_cvd** — Family history of cardiovascular disease  
- **af** — Atrial fibrillation  
- **atypical_antipsych** — Use of atypical antipsychotics  
- **steroids** — Regular corticosteroid use  
...
- **ed** — Erectile dysfunction (male-specific QRISK3 variable)  
    """
    )
    st.divider()
...
label2 = ":red[How to Interpret the Results & Technical Context]"
with st.expander(label2):
        st.markdown(
        """
**Output Columns (Generated by App)**
- **prevent_* ** — PREVENT model estimated risk probabilities  
- **ascvd_pce_10yr_percent** — 10-year ASCVD risk (ACC/AHA PCE)  
- **score2_10yr_percent** — SCORE2 10-year cardiovascular risk (%)  
- **qrisk3_10yr_percent** — QRISK3 10-year cardiovascular risk (%)  
- **frs2008_10yr_percent** — Framingham 2008 10-year cardiovascular risk (%)  
    """
    )
